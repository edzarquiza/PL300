...
export function saveExamResult(result) {
  ...
  const { score, domainBreakdown, subtopicBreakdown, mode, timeSpent, questionCount, confidence, questionTimes, trapStats, trackId } = result
  history.unshift({ score, domainBreakdown, subtopicBreakdown, mode, timeSpent, questionCount, confidence, questionTimes, trapStats, trackId, savedAt: Date.now() })
